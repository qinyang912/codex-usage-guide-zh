...
这可能是模型发现信息、账号灰度或实际响应后端暂时不同步。openai/codex issue #26892 曾记录本地列表显示模型可用，但 Desktop 与 CLI 的真实请求都返回 404；OpenAI 工作人员后来确认该次是后端问题。
...
更完整的中文分流、8 项 FAQ 与相关错误入口：

https://hi-codex.com/guides/codex-model-not-found-404/?utm_source=github&utm_medium=guide&utm_campaign=codex_model_404
