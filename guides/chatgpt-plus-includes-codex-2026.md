...
> 核对日期：2026-07-21。本文只讨论 OpenAI 官方 ChatGPT 套餐与 Codex 的关系，不把第三方“激活码”、共享账号或 API 中转余额当作官方 Codex 套餐。
...
- 套餐包含用量：跟随 ChatGPT Free、Go、Plus 或 Pro。
- ChatGPT Credits：符合条件的账号可在 Usage 页面按需购买，用于支持的 ChatGPT 功能。
