...
OpenAI 当前帮助说明中有一个容易忽略的规则：在对应功能可用的套餐里，Codex、ChatGPT Work、ChatGPT for Excel 和 Workspace Agents 使用同一个 agentic usage 与 Credits 池。因此，即使没有继续使用 Codex CLI，同一账号或工作区的其他 agentic 入口也可能让剩余用量下降。
